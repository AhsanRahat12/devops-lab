...
This repository contains raw troubleshooting notes, configuration guides, and technical documentation from my daily learning. It's not polished tutorials - it's real problems I've encountered and how I solved them.
...
- **Operating Systems:** Arch Linux, Raspberry Pi OS
- **Security:** GPG, SSH, YubiKey, credential management
- **Display Servers:** Wayland, X11, XWayland
- **Tools:** systemd, pass, git
...
**Note:** These are working notes, not polished articles. They're written primarily for my own reference, but shared publicly in case they help others troubleshooting similar issues.
